...
public class RightDrivetrain extends PIDSubsystem {
	...
	public RightDrivetrain(){
		...
		motor1.configSelectedFeedbackSensor(FeedbackDevice.QuadEncoder, 1, 10);
		...
		motor1.setSelectedSensorPosition(0, 1, 10);
    }
	public void setMotors(double power) {
		motor1.set(ControlMode.PercentOutput, -power);
		SmartDashboard.putNumber("Right Drive", motor1.getSelectedSensorPosition(0));
	}
