...
public class AutoLineAuto extends DynamicAuton {
	 @Override
	    protected Command buildCommand(char pos, String gameData) {
	        return new AutoLineAutoCG(pos, gameData);
	    }

	private class AutoLineAutoCG extends CommandGroup {
		 	AutoLineAutoCG(char pos, String gameData) {
